...
if (!MONGO_URI) {
  console.error(
    "❌ MONGO_URI is not defined in .env. Please add it (your Atlas connection string)."
  );
  process.exit(1);
}
...
// Support HTTP OPTIONS preflight requests for CORS
app.options('*', cors());
...
const server = app.listen(PORT, () => {
  console.log(`
🚀 Expensy AI Backend Server Started!
